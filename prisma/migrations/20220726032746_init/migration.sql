...
-- CreateEnum
CREATE TYPE "EstadoCargo" AS ENUM ('pendiente', 'completado');

-- CreateEnum
CREATE TYPE "Naturaleza" AS ENUM ('cargo', 'abono');
...
-- CreateTable
CREATE TABLE "CatalogoTipoCargo" (
    "id" SERIAL NOT NULL,
    "description" VARCHAR(128),

    CONSTRAINT "CatalogoTipoCargo_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "CatalogoTipoLote" (
    "id" SERIAL NOT NULL,
    "description" VARCHAR(128) NOT NULL,

    CONSTRAINT "CatalogoTipoLote_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "CatalogoTipoPublicacion" (
    "id" SERIAL NOT NULL,
    "description" VARCHAR(128) NOT NULL,

    CONSTRAINT "CatalogoTipoPublicacion_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Neighbor" ADD CONSTRAINT "Neighbor_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES "Profile"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
